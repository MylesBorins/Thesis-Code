...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 209.0, 84.0, 18.0 ],
					"text" : "#1 0 $1 $2 $3"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 144.0, 51.0, 18.0 ],
									"text" : "#1 1 $1"
								}
...
,
					"patching_rect" : [ 41.5, 94.0, 81.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 114.0, 128.0, 81.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 271.0, 33.0, 20.0 ],
					"text" : "s #2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 6.0, 7.0, 127.0, 75.0 ],
					"presentation" : 1,
					"presentation_rect" : [ -2.0, -2.0, 127.0, 75.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 51.0, 114.0, 36.0, 114.0, 36.0, 111.0, 3.0, 111.0, 3.0, 258.0, 15.5, 258.0 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-15::obj-15" : [ "live.toggle[1]", "live.toggle", 0 ],
